#Богомаз Алексей
"""
Это программа по двум последним заданиям. Сделал два в одном. Интерактивное приложение по вводу 
данных float в поля х/у для автоматического создания графика и баров (столбики)
и по формулам аэродинам сопротивления и подъемной силы.
"""
